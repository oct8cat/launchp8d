(function() {
     ...
     * @type object
     */
    Launchpad.client = Launchpad.redis.createClient(settings.redis.port, settings.redis.host);

    /**
     * Subscriber-mode redis client reference.
     * @type object
     */
    Launchpad.subClient = Launchpad.redis.createClient(settings.redis.port, settings.redis.host);
